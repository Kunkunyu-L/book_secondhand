...
import { User, Reading, Document, Money, Bell } from '@element-plus/icons-vue'
...
<template>
  <div v-loading="loading">
    <el-row :gutter="20" class="stat-cards">
      ...
      <el-col :xs="12" :sm="6">
        <el-card shadow="never" class="stat-card">
          <div class="stat-icon"><el-icon :size="24"><Reading /></el-icon></div>
          <div class="stat-info">
      ...
      <el-col :xs="12" :sm="6">
        <el-card shadow="never" class="stat-card">
          <div class="stat-icon"><el-icon :size="24"><Money /></el-icon></div>
          <div class="stat-info">
    ...
    <el-row :gutter="20" style="margin-top: 20px">
      <el-col :xs="24" :sm="12">
        <el-card shadow="never">
          <template #header>
            <div class="card-header"><span>今日概览</span></div>
          </template>
