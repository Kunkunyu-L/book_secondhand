<template>
  <view class="sessions-page">
    <scroll-view scroll-y class="session-list" :show-scrollbar="false">
...
<style scoped>
.sessions-page { height: 100vh; display: flex; flex-direction: column; background: #f5f5f5; box-sizing: border-box; padding-bottom: 50px; }
